...
t_hash				**asm_get_opers_hash(void)
{
	...
	oper = asm_init_oper("sub", 0x05, ARG_1_REG | ARG_2_REG | ARG_3_REG);
	push_hash(opers_hash, "sub", (void *)oper, OPERS_SIZE);
	oper = asm_init_oper("and", 0x06, ARG_1_ALL | ARG_2_ALL | ARG_3_REG);
	push_hash(opers_hash, "and", (void *)oper, OPERS_SIZE);
	oper = asm_init_oper("or", 0x07, ARG_1_ALL | ARG_2_ALL | ARG_3_REG);
	push_hash(opers_hash, "or", (void *)oper, OPERS_SIZE);
	oper = asm_init_oper("xor", 0x08, ARG_1_ALL | ARG_2_ALL | ARG_3_REG);
	push_hash(opers_hash, "xor", (void *)oper, OPERS_SIZE);
	oper = asm_init_oper("zjmp", 0x09, ARG_1_DIR & ~ARG_TYPE);
