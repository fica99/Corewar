...
/*   Updated: 2020/10/28 20:24:39 by sschmele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
											...
											t_hash **opers_hash)
{
	...
	else if (asm_lex_is_arg_dir(asm_str))
		return (asm_lex_token_arg_dir(asm_str));
	else if (asm_lex_is_arg_ind(asm_str))
		return (asm_lex_token_arg_ind(asm_str));
